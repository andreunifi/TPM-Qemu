...
```
cd existing_repo
git remote add origin https://baltig.polito.it/cs4es2025/group7-TPM.git
git branch -M main
...
- [ ] [Set up project integrations](https://baltig.polito.it/cs4es2025/group7-TPM/-/settings/integrations)
